...
async function bootstrap() {
  ...
  initRemoteConfig({
    ...
    // загрузки — без конфига поправка нулевая, но флаг проставится, иначе сейв
    // ждал бы ответа, которого не будет. Подробности — в storage.js.
    storage.applyStartGrant(tuned('hints_start', CONFIG.BALANCE.startingHints));
